...
static int fake_stepper_drv_set_micro_step_res_delegate(const struct device *dev,
...
static void fake_stepper_reset_rule_before(const struct ztest_unit_test *test, void *fixture)
{
	...
	fake_stepper_drv_get_micro_step_res_fake.custom_fake = fake_stepper_drv_get_micro_step_res_delegate;
...
#define FAKE_STEPPER_DRIVER_INIT(inst)                                                                    \
	...
	static struct fake_stepper_driver_data fake_stepper_driver_data_##inst;                                  \
																								   \
	DEVICE_DT_INST_DEFINE(inst, fake_stepper_driver_init, NULL, &fake_stepper_driver_data_##inst, NULL,      \
...
#define FAKE_STEPPER_CONTROLLER_INIT(inst)                                                                    \
	...
	static struct fake_stepper_controller_data fake_stepper_controller_data_##inst;                                  \
                                                                                                   \
	DEVICE_DT_INST_DEFINE(inst, fake_stepper_controller_init, NULL, &fake_stepper_controller_data_##inst, NULL,      \
			      POST_KERNEL, CONFIG_STEPPER_INIT_PRIORITY,                           \
				  &fake_stepper_controller_api);
