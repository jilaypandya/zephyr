 ...
 * @param dev Pointer to the device structure.
 */
void update_direction_from_step_count(const struct device *dev);

/**
 * @brief Update the remaining steps to move for the stepper motor.
 * @param dev Pointer to the device structure.
 */
void update_remaining_steps(const struct device *dev);

/**
 * @brief Task for controlling the stepper motor in position mode.
 * @param dev Pointer to the device structure.
 */
void position_mode_task(const struct device *dev);
