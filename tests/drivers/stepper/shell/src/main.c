...
{
	const struct shell *sh = shell_backend_dummy_get_ptr();
	int err = shell_execute_cmd(sh, "stepper move_by " FAKE_STEPPER_CONTROLLER FAKE_STEPPER_INDEX " 1000");
...
{
	const struct shell *sh = shell_backend_dummy_get_ptr();
	int err = shell_execute_cmd(sh, "stepper set_microstep_interval " FAKE_STEPPER_CONTROLLER FAKE_STEPPER_INDEX " 200");
...
{
	const struct shell *sh = shell_backend_dummy_get_ptr();
	int err = shell_execute_cmd(sh, "stepper set_reference_position " FAKE_STEPPER_CONTROLLER FAKE_STEPPER_INDEX " 100");
...
{
	const struct shell *sh = shell_backend_dummy_get_ptr();
	int err = shell_execute_cmd(sh, "stepper get_actual_position " FAKE_STEPPER_CONTROLLER FAKE_STEPPER_INDEX);
...
{
	const struct shell *sh = shell_backend_dummy_get_ptr();
	int err = shell_execute_cmd(sh, "stepper move_to " FAKE_STEPPER_CONTROLLER FAKE_STEPPER_INDEX " 200");
...
{
	const struct shell *sh = shell_backend_dummy_get_ptr();
	int err = shell_execute_cmd(sh, "stepper run " FAKE_STEPPER_CONTROLLER FAKE_STEPPER_INDEX " positive");
...
{
	const struct shell *sh = shell_backend_dummy_get_ptr();
	int err = shell_execute_cmd(sh, "stepper run " FAKE_STEPPER_CONTROLLER FAKE_STEPPER_INDEX " foo");
...
{
	const struct shell *sh = shell_backend_dummy_get_ptr();
	int err = shell_execute_cmd(sh, "stepper control info " FAKE_STEPPER_CONTROLLER FAKE_STEPPER_INDEX);
