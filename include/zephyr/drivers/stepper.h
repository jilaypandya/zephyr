 ...
 * @retval 0 Success
 */
__syscall int stepper_move_to(const struct device *dev, const uint8_t stepper_index, int32_t micro_steps);

static inline int z_impl_stepper_move_to(const struct device *dev, const uint8_t stepper_index, const int32_t micro_steps)
{
	const struct stepper_driver_api *api = (const struct stepper_driver_api *)dev->api;
 ...
 * @retval 0 Success
 */
__syscall int stepper_is_moving(const struct device *dev, const uint8_t stepper_index, bool *is_moving);

static inline int z_impl_stepper_is_moving(const struct device *dev, const uint8_t stepper_index, bool *is_moving)
{
	const struct stepper_driver_api *api = (const struct stepper_driver_api *)dev->api;
